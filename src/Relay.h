...
class Relay {
 ...
 public:
  ...
  boost::shared_ptr<TunnelStream>  openStream(std::string &nextHost, uint16_t nextPort,
          nodeType relay_type, std::string &endHost, uint16_t endPort, boost::system::error_code *err);
